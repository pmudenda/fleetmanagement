...
@section('content')
    ...
    <div class="container">
        <form name="saveRecord" id="my-form" class="form-wrapper" action="{{route('accident.record')}}" method="POST">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="regInput">
                                <input name="registrationNo" type="text" class="form-control required" id="registrationNo" placeholder="AAA0000" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input name="chassisNo" type="text" class="form-control disableVehicle" id="chassisNo" placeholder="Enter Chassis No" required>
                            @error('chassisNo')
                            <p>{{$message}}</p>
        ...
        <section class="second-section">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="ownerAddress">Type of Accident*:</label>
                        <select name="accidentType" class="form-control required">
                ...
                <div class="col-md-6">
                    <label for="ownerAddress">Nature of accident*:</label>
                    <select name="accidentNature" class="form-control required">
                        <option>Select Incident Nature</option>
                        <option>One</option>
                        <option>two</option>
                        <option>two</option>
                    </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="ownerAddress">Number of people involved:</label>
                        <input name="peopleInvolved" type="number" class="form-control required" id="ownerAddress" placeholder="Enter Number of people Involved" required>
                    </div>
                    @error('peopleInvolved')
                    <p>{{$message}}</p>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        <label for="ownerAddress">Date*:</label>
                        <input name="date" type="date" class="form-control required" id="ownerAddress" placeholder="00/00/0000" required>
                    </div>
                    @error('date')
                    <p>{{$message}}</p>
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        <label for="ownerAddress">Time*:</label>
                        <input name="time" type="time" class="form-control required" id="ownerAddress" placeholder="00:00" required>
                    </div>
                    @error('time')
                    <p>{{$message}}</p>
                ...
                <div class="col-md-12">
                    <div class="form-group ">
                        <label for="accidentDescription">Description Of Accident:</label>
                        <textarea  class="form-control" id="accidentDescription" name="description" rows="5" cols="20"></textarea>
                        @error('description')
                        <p>{{$message}}</p>
        ...
        <section class="third-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        <label for="driverName">Name:</label>
                        <input name="driverName" type="text" class="form-control required" id="driverName" placeholder="Enter Driver Name" required>
                    </div>
                    @error('driverName')
                    <p>{{$message}}</p>
