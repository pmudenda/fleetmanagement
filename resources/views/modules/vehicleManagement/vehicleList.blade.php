            ...
            <div class="card-body pt-0">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card px-0">
                        ...
                        <div id="collapseOne" style="display: none;" class="collapse" aria-labelledby="headingOne"
                             data-parent="#accordionExample">
                            <div class="card-body px-0">
                                <div class="listqbe">
                                    <div class="sys-list-filterhead"><span class="lbl">Filter:</span><select
                                            class="hq-listselector">
                                            <option>My Default Filter</option>
                                        </select><a class="sys-button showborder marginleft font34"
                                                    style="cursor: pointer;"><i
                                                class="fa fa-pencil"></i> <span>Hide Filter</span></a></div>
                                    <div class="qbeinner" style="">
                                        <div class="qbetoolbar" style="visibility: visible;"><a
                                                class="toolbarbutton"><i
                                                    class="fa fa-save"></i> Save</a><a class="toolbarbutton"><i
                                                    class="fa fa-save"></i>
                                                Save As</a><a class="toolbarbutton"><i class="fa fa-trash-o"></i>
                                                Delete</a><a
                                                class="toolbarbutton"><i class="fa fa-undo"></i> Reset</a><a
                                                class="toolbarbutton"><i
                                                    class="fa fa-thumbs-down"></i> Clear</a><a
                                                class="toolbarbutton listrefreshbutton"><i class="fa fa-search"></i>
                                                Get
                                                Records</a>
                                        </div>
                                        <div data-qbefield="systemname" class="qbefield"><i class="fa fa-remove"
                                                                                            title="Remove this field"
                                                                                            style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Module">Module</label>
                                            ...
                                            <input type="text" class="qbeinput qbeinputin" style=""><span
                                                class="qbelabelin"
                                                style="display:none">(use ; to separate values)</span>
                                        </div>
                                        <div data-qbefield="tasknumber" class="qbefield"><i class="fa fa-remove"
                                                                                            title="Remove this field"
                                                                                            style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Task #">Task #</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                            ...
                                            <input type="text" class="qbeinput"><input type="text"
                                                                                       class="qbeinputupper"
                                                                                       style="display:none"></div>
                                        <div data-qbefield="originatoruser" class="qbefield"><i class="fa fa-remove"
                                                                                                title="Remove this field"
                                                                                                style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Originator">Originator</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="0">is</option>
                                                    <option value="16">is not</option>
                                            ...
                                            <input type="text" class="qbeinput qbeinputin" style=""><span
                                                class="qbelabelin"
                                                style="display:none">(use ; to separate values)</span><i
                                                class="fa fa-fw fa-user" style="cursor:pointer;"
                                                title="Select User"></i></div>
                                        <div data-qbefield="dateopened" class="qbefield"><i class="fa fa-remove"
                                                                                            title="Remove this field"
                                                                                            style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Date Opened">Date Opened</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="12">&gt;=</option>
                                                    <option value="11">&lt;=</option>
                                                    <option value="10">&gt;</option>
                                            ...
                                            <input type="text" class="qbeinput adddatepicker hasDatepicker"
                                                   id="dp1675929085275"><input
                                                type="text" class="qbeinputdatenum" style="display:none"><input
                                                type="text"
                                                class="qbeinputupper adddatepicker hasDatepicker"
                                                style="display:none"
                                                id="dp1675929085276">
                                        </div>
                                        <div data-qbefield="tasksubject" class="qbefield"><i class="fa fa-remove"
                                                                                             title="Remove this field"
                                                                                             style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Subject">Subject</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="0">is</option>
                                                    <option value="16">is not</option>
                                                    <option value="1">starts with</option>
                                        ...
                                        <div data-qbefield="assigneeuser" class="qbefield"><i class="fa fa-remove"
                                                                                              title="Remove this field"
                                                                                              style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Assignee">Assignee</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="0">is</option>
                                                    <option value="16">is not</option>
                                                    <option value="13">Is Current User</option>
                                            ...
                                            <input type="text" class="qbeinput qbeinputin" style=""><span
                                                ...
                                                class="fa fa-fw fa-user" style="cursor:pointer;"
                                                title="Select User"></i></div>
                                        <div data-qbefield="datedue" class="qbefield"><i class="fa fa-remove"
                                                                                         title="Remove this field"
                                                                                         style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Date Due">Date Due</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="12">&gt;=</option>
                                                    <option value="11">&lt;=</option>
                                                    <option value="10">&gt;</option>
                                        ...
                                        <div data-qbefield="datecompleted" class="qbefield"><i class="fa fa-remove"
                                                                                               title="Remove this field"
                                                                                               style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Date Completed">Date Completed</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="12">&gt;=</option>
                                                    <option value="11">&lt;=</option>
                                                    <option value="10">&gt;</option>
                                        ...
                                        <div data-qbefield="dateclosed" class="qbefield"><i class="fa fa-remove"
                                                                                            title="Remove this field"
                                                                                            style="cursor:pointer;"></i><label
                                        ...
                                        <div data-qbefield="result" class="qbefield"><i class="fa fa-remove"
                                                                                        title="Remove this field"
                                                                                        style="cursor:pointer;"></i><label
                                                class="qbefieldlabel" title="Action">Action</label>
                                            <div class="qbeoperator"><select class="qbeoperator">
                                                    <option value="0">is</option>
                                                    <option value="16">is not</option>
                                                    <option value="1">starts with</option>
                                        ...
                                        <div style="clear:both"><select class="extraqbe"
