                ...
                if (vehicle && vehicle.brand_name) {
                    ...
                    if (typeof vehicle.fuel_allocation === 'undefined' || vehicle.fuel_allocation == null || vehicle.fuel_allocation === "0") {
                        ...
                        tmsApp.showSystemMessage(
                            ...
                            'Vehicle has no Fuel Allocation, ' +
                    ...
                    if (vehicle['on_boarding_status'] != '030') {
                        tmsApp.showSystemMessage("Vehicle Details Incomplete",
                            'Vehicle did not complete onboarding process, ' +
                            'You can not proceed with requisition', () => {
                        }, "error")
                    ...
                    let row = `<tr>
                                    ...
                                    <td id="make">${vehicle.brand_name}</td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                     ...
                                     <td id="registration">${vehicle['registration_number']}</td>
                                </tr>`;
                    ...
                    if (vehicle.fuel_allocation) {
                        ...
                        document.querySelector('[name="material_quantity"]')
                            .setAttribute('max', perWeekAllocation);
