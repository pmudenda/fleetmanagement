            ...
            <div class="card card-flush h-md-100">
                ...
                <div class="card-body pt-1">
                    ...
                    <div class="d-flex flex-column text-gray-600">
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> All
                            Admin Controls
                        </div>
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> View
                            and Edit Financial Summaries
                        </div>
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> Enabled
                            Bulk Reports
                        </div>
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> View
                            and Edit Payouts
                        ...
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> <em>and
                                7 more...</em></div>
                    </div>
                    <!--end::Permissions-->
                </div>
                ...
                <div class="card-footer flex-wrap pt-0">
                    <a href="/metronic8/demo1/../demo1/apps/user-management/roles/view.html"
        ...
        <div class="col-md-4">
            ...
            <div class="card card-flush h-md-100">
                ...
                <div class="card-body pt-1">
                    ...
                    <!--begin::Permissions-->
                    <div class="d-flex flex-column text-gray-600">
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> Some
                            Admin Controls
                        </div>
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> View
        ...
        <div class="col-md-4">
            ...
            <div class="card card-flush h-md-100">
                ...
                <div class="card-body pt-1">
                    ...
                    <!--begin::Permissions-->
                    <div class="d-flex flex-column text-gray-600">
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> No
                            Admin Controls
                        </div>
                        <div class="d-flex align-items-center py-2"><span class="bullet bg-primary me-3"></span> View
                            and Edit Financial Summaries
            ...
            <div class="card h-md-100">
                ...
                <div class="card-body d-flex flex-center">
                    ...
                    <button type="button" class="btn btn-clear d-flex flex-column flex-center" data-bs-toggle="modal"
                        ...
                        <!--begin::Illustration-->
                        <img src="/metronic8/demo1/assets/media/illustrations/sketchy-1/4.png" alt=""
