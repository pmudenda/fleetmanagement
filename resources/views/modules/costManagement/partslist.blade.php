                ...
                <ul class="metismenu">
                    ...
                    <li class="mm-active">
                        ...
                        <ul class="nav-second-level mm-collapse mm-show" style="">
                            ...
                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/partslist')" aria-expanded="true">Manage Parts</a>
                            </li>
                            ...
                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/stocklist')" aria-expanded="false">Stock Management</a>
                            </li>
                ...
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="nav-clock">
                        <div class="time">
                            ...
                            <span class="time-min">42</span>
                            <span class="time-sec">35</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/add_parts" id="location" class="row" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="category_name" id="category_name" data-select2-id="category_name" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="418">Please Select One</option>
                                                    <option value="MPV">MPV</option>
                                                    <option value="Battery">Battery</option>
                                                    <option value="Tire">Tire</option>
                                                    <option value="Clutch">Clutch</option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="417" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-category_name-container"><span class="select2-selection__rendered" id="select2-category_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="location_name" id="location_name" data-select2-id="location_name" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="420">Please Select One</option>
                                                    <option value="D-MRT">D-MRT</option>
                                                    <option value="MAIN">MAIN</option>
                                                    <option value="Rampura">Rampura</option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="419" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-location_name-container"><span class="select2-selection__rendered" id="select2-location_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="example_parts_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group">          <button class="btn btn-secondary buttons-copy buttons-html5 btn-success" tabindex="0" aria-controls="example_parts" type="button"><span>Copy</span></button> <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0" aria-controls="example_parts" type="button"><span>Excel</span></button> <button class="btn btn-secondary buttons-pdf buttons-html5 btn-success" tabindex="0" aria-controls="example_parts" type="button"><span>PDF</span></button> <button class="btn btn-secondary buttons-print btn-success" tabindex="0" aria-controls="example_parts" type="button"><span>Print</span></button> <div class="btn-group"><button class="btn btn-secondary buttons-collection dropdown-toggle buttons-colvis btn-success" tabindex="0" aria-controls="example_parts" type="button" aria-haspopup="true" aria-expanded="false"><span>Column visibility</span></button></div> </div></div><div class="col-lg-6 col-md-12"><div id="example_parts_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="example_parts"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="example_parts" class="table display table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="example_parts_info">
                                                    <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-sort="ascending" aria-label="SL: activate to sort column descending" style="width: 53.4844px;">SL</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Parts Name: activate to sort column ascending" style="width: 153.953px;">Parts Name</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Description: activate to sort column ascending" style="width: 150.531px;">Description</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Category Name: activate to sort column ascending" style="width: 196.156px;">Category Name</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Stock Limit: activate to sort column ascending" style="width: 152.109px;">Stock Limit</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Location Name: activate to sort column ascending" style="width: 188.891px;">Location Name</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Remarks: activate to sort column ascending" style="width: 120.828px;">Remarks</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 96.3281px;">Status</th><th class="sorting" tabindex="0" aria-controls="example_parts" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 111.719px;">Action</th></tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>Active</td>
                                                        <td>
                                                            <input name="url" type="hidden" id="url_2" value="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/updatepartsfrm">
                                                            ...
                                                            <a href="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/delete_parts/2" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                                        </td>
                                                        ...
                                                        <td>Active</td>
                                                        <td>
                                                            <input name="url" type="hidden" id="url_3" value="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/updatepartsfrm">
                                                            ...
                                                            <a href="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/delete_parts/3" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                                        </td>
                                                    </tr></tbody>
                                                </table></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="example_parts_info" role="status" aria-live="polite">Showing 1 to 2 of 2 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="example_parts_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="example_parts_previous"><a href="#" aria-controls="example_parts" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="example_parts" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="example_parts_next"><a href="#" aria-controls="example_parts" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/parts_list.js"></script></div>
