                ...
                <ul class="metismenu">
                    ...
                    <li class="mm-active">
                        ...
                        <ul class="nav-second-level mm-collapse mm-show" style="">
                            ...
                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/categorylist')" aria-expanded="true">Category</a>
                            </li>
    ...
    <div class="content-wrapper">
        <div class="main-content position-relative">
            ...
            <div class="body-content" id="bodycontent"><div id="add0" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/add_category" id="category" class="row" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table display table-bordered table-striped table-hover ">
                                        ...
                                        <tr>
                                            ...
                                            <td>Active</td>
                                            <td>
                                                <input name="url" type="hidden" id="url_2" value="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/updatecategoryfrm">
                                                ...
                                                <a href="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/delete_category/2" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td>Active</td>
                                            <td>
                                                <input name="url" type="hidden" id="url_3" value="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/updatecategoryfrm">
                                                ...
                                                <a href="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/delete_category/3" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            ...
                                            <td>Inactive</td>
                                            <td>
                                                <input name="url" type="hidden" id="url_4" value="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/updatecategoryfrm">
                                                ...
                                                <a href="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/delete_category/4" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>4</td>
                                            ...
                                            <td>Inactive</td>
                                            <td>
                                                <input name="url" type="hidden" id="url_7" value="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/updatecategoryfrm">
                                                ...
                                                <a href="https://vmsdemo.bdtask-demo.com/costManagement/costManagement/delete_category/7" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                ...
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/category_list.js"></script></div>
