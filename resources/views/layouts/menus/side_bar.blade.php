            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item d-none">
                            <a href="{{ route('new.parts.requisition') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('new.fuel.requisition') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Fuel Requisition</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('users.new') }}"><span
