...
<div id="kt_activities" class="bg-body drawer drawer-end" data-kt-drawer="true" data-kt-drawer-name="activities"
    ...
    data-kt-drawer-close="#kt_activities_close" style="width: 900px !important;">
    ...
    <div class="card shadow-none border-0 rounded-0">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div
                                    ...
                                    <!--begin::Title-->
                                    <a href="../demo1/apps/projects/project.html"
        ...
        <div class="card-footer py-5 text-center" id="kt_activities_footer">
            <a href="../demo1/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">
                View All Activities
