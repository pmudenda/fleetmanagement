<div class="app-navbar-item ms-1 ms-md-3">
    ...
    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px"
        ...
        <span class="svg-icon svg-icon-2 svg-icon-md-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab"
                        href="#kt_topbar_notifications_2" aria-selected="true" role="tab">Updates</a>
                </li>

                <li class="nav-item" role="presentation">
                    <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab"
                        href="#kt_topbar_notifications_3" aria-selected="false" tabindex="-1" role="tab">Logs</a>
                </li>
            </ul>
            <!--end::Tabs-->
        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-primary">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-primary"><svg width="24" height="24"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-danger">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-danger"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-warning">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-warning"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-success">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-success"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-info">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-info"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-warning">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-warning"><svg width="24" height="25"
