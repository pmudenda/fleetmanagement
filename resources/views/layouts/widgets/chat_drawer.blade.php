<div id="kt_shopping_cart" class="bg-body drawer drawer-end" data-kt-drawer="true" data-kt-drawer-name="cart"
    ...
    data-kt-drawer-close="#kt_drawer_shopping_cart_close" style="width: 500px !important;">
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex flex-column me-3">
                    <!--begin::Section-->
                    <div class="mb-3">
                        <a href="../demo1/apps/ecommerce/sales/details.html"
...
<div id="kt_drawer_chat" class="bg-body drawer drawer-end" data-kt-drawer="true" data-kt-drawer-name="chat"
    ...
    data-kt-drawer-close="#kt_drawer_chat_close" style="width: 500px !important;">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-2">
                    <button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button"
                        ...
                        data-kt-initialized="1"><i class="bi bi-paperclip fs-3"></i></button>
                    <button class="btn btn-sm btn-icon btn-active-light-primary me-1" type="button"
                        data-bs-toggle="tooltip" aria-label="Coming soon" data-bs-original-title="Coming soon"
                        data-kt-initialized="1"><i class="bi bi-upload fs-3"></i></button>
                </div>
                <!--end::Actions-->
