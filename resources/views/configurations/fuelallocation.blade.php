                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-6">
                                                            <div class="input-group">
                                                                <input type="text"
                                                                    data-action="http://127.0.0.1:8000/vehicle-management/vehicle/details"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                                            <input type="hidden" class="form-control form-control-sm"
                                                                id="vehicle_description" name="vehicle_description"
                                                                required readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="link-field ui-front"
                                                                    ...
                                                                    <label class="form-check-inline">
                                                                        <input type="radio" id="costOnCostCentre"
                                                                            ...
                                                                            name="CostAssignedTo"
                                                                            value="CostCenterBasedRequisition" checked>
                                                                        Cost Center
                                                                    </label>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="link-field ui-front"
                                                                    ...
                                                                    <label class="form-check-inline">
                                                                        <input type="radio" id="projectInput"
                                                                            class="list-row-checkbox bold mr-3 when_valid"
                                                                            autocomplete="off" name="CostAssignedTo"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-7 col-lg-6">
                                                            <select name="requisition_type" id="requisition_type"
                                                                disabled class="form-control form-select-sm when_valid"
                                                                required>
...
$(function() {
  // Your code here
  // This code will run only when the DOM is ready
  // You can manipulate DOM elements, bind events, etc.
});
