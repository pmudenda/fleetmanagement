        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" v-model="search" data-kt-table-filter="search"
                           class="form-control form-control-solid w-250px ps-14" placeholder="Search Models">
                </div>
            </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-table-toolbar="base">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_add" class="btn btn-primary">
                ...
                <div class="d-flex justify-content-end align-items-center d-none" data-kt-table-toolbar="selected">
                    ...
                    <button type="button" class="btn btn-danger" data-kt-table-select="delete_selected">
                        Delete Selected
                    </button>
                </div>
                            ...
                            <div class="fv-row">
                                ...
                                <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                    <label for="model_name"
                                        ...
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                           aria-label="Specify model name" data-bs-original-title="Specify model name"
                                           data-kt-initialized="1"></i>
                                    </label>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                    <label for="model_code"
                                        ...
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                           aria-label="Specify model code" data-bs-original-title="Specify model code"
                                           data-kt-initialized="1"></i>
                                    </label>
    ...
    <script>
        let app = new Vue({
            ...
            methods: {
                ...
                postRequest() {
                    const submitButton = app.modalEl.querySelector('#kt_modal_add_submit');
                    axios.post(document.querySelector('#modelEndpoint').value, {
