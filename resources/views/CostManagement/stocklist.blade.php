...
<div class="wrapper">
        ...
        <div class="sidebar-body ps ps--active-y">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="mm-active">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="true"><div class="material-ink animate" style="height: 220px; width: 220px; top: -89px; left: -29px;"></div><i class="typcn icon-default typcn-ticket mr-2"></i>Cost &amp; Inventory</a>
            ...
            <div class="ps__rail-x" style="left: 0px; top: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 509px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 333px;"></div></div></div> </nav>
    ...
    <div class="content-wrapper">
        <div class="main-content position-relative">
                ...
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="nav-clock">
                        <div class="time">
                            ...
                            <span class="time-min">44</span>
                            <span class="time-sec">11</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="body-content" id="bodycontent"><div class="row">
                    <div class="col-sm-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body row">
                                <div class="col-sm-12 col-xl-4">
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control basic-single select2-hidden-accessible" name="category_name" id="category_name" onchange="getproduct()" data-select2-id="category_name" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="426">Please Select One</option>
                                                <option value="MPV">
                                                    MPV</option>
                                                ...
                                                <option value="Clutch">
                                                    Clutch</option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="425" style="width: 330.656px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-category_name-container"><span class="select2-selection__rendered" id="select2-category_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-8" id="fullitem">
                                            <select class="form-control basic-single select2-hidden-accessible" name="item_name" id="item_name" data-select2-id="item_name" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="428">Please Select One</option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="427" style="width: 330.656px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-item_name-container"><span class="select2-selection__rendered" id="select2-item_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-xl-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="stock_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group">          <button class="btn btn-secondary buttons-copy buttons-html5 btn-success" tabindex="0" aria-controls="stock" type="button"><span>Copy</span></button> <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0" aria-controls="stock" type="button"><span>Excel</span></button> <button class="btn btn-secondary buttons-pdf buttons-html5 btn-success" tabindex="0" aria-controls="stock" type="button"><span>PDF</span></button> <button class="btn btn-secondary buttons-print btn-success" tabindex="0" aria-controls="stock" type="button"><span>Print</span></button> <div class="btn-group"><button class="btn btn-secondary buttons-collection dropdown-toggle buttons-colvis btn-success" tabindex="0" aria-controls="stock" type="button" aria-haspopup="true" aria-expanded="false"><span>Column visibility</span></button></div> </div></div><div class="col-lg-6 col-md-12"><div id="stock_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="stock"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="stock" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" role="grid" aria-describedby="stock_info" style="width: 1545px;">
                                                    <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 85px;" aria-sort="ascending" aria-label="SL: activate to sort column descending">SL</th><th class="sorting" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 278px;" aria-label="Category Name: activate to sort column ascending">Category Name</th><th class="sorting" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 211px;" aria-label="Item Name: activate to sort column ascending">Item Name</th><th class="sorting" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 212px;" aria-label="In Quantity: activate to sort column ascending">In Quantity</th><th class="sorting" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 240px;" aria-label="Out Quantity: activate to sort column ascending">Out Quantity</th><th class="sorting" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 297px;" aria-label="Current Quantity: activate to sort column ascending">Current Quantity</th><th class="sorting" tabindex="0" aria-controls="stock" rowspan="1" colspan="1" style="width: 0px;" aria-label="Stock Value: activate to sort column ascending">Stock Value</th></tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr role="row" class="odd"><td class="sorting_1" tabindex="0">1</td><td>a</td><td></td><td>2</td><td></td><td>2</td><td style="">4.00</td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">2</td><td>Battery 007</td><td>Batter A-01</td><td>2</td><td></td><td>2</td><td style="">500.00</td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">3</td><td>dfgdg</td><td></td><td>0</td><td>6767</td><td>-6767</td><td style="">nan</td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">4</td><td>getrty</td><td>Seat Belt</td><td>10</td><td>2</td><td>8</td><td style="">640.00</td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">5</td><td>ghj</td><td>ghj</td><td>5</td><td></td><td>5</td><td style="">150.00</td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">6</td><td>mkl</td><td>df</td><td>50</td><td></td><td>50</td><td style="">500.00</td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">7</td><td>MPV</td><td>Part Name 123</td><td>4</td><td></td><td>4</td><td style="">200.00</td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">8</td><td>MPV</td><td>Wheel</td><td>27</td><td>3</td><td>24</td><td style="">631.11</td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">9</td><td>new</td><td>ghjgg</td><td>5</td><td></td><td>5</td><td style="">3,285.00</td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">10</td><td>Tyres</td><td>Tyre</td><td>10</td><td></td><td>10</td><td style="">2,000.00</td></tr></tbody>
                                                </table><div id="stock_processing" class="dataTables_processing card" style="display: none;">Processing...</div></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="stock_info" role="status" aria-live="polite">Showing 1 to 10 of 10 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="stock_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="stock_previous"><a href="#" aria-controls="stock" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="stock" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="stock_next"><a href="#" aria-controls="stock" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/stock_list.js"></script></div>
