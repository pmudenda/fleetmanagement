    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img alt="image" src="@/assets/media/avatars/profile.png" />
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a class="text-gray-900 text-hover-primary fs-2 fw-bold me-1" href="#">Max Smith</a>
                            <a href="#">
                                <span class="svg-icon svg-icon-1 svg-icon-primary"><svg height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="btn btn-sm btn-light-success fw-bold ms-2 fs-8 py-1 px-3" data-bs-target="#kt_modal_upgrade_plan" data-bs-toggle="modal" href="#">Upgrade to Pro</a>
                        </div>
                        <!--end::Name-->
                        ...
                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                            <a class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2" href="#">
                                <span class="svg-icon svg-icon-4 me-1"><svg fill="none" height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <rect fill="currentColor" height="4" rx="2" width="4" x="7" y="6"></rect>
                                    </svg>
                                </span>
                                Developer
                            </a>
                            <a class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2" href="#">
                                ...
                                <span class="svg-icon svg-icon-4 me-1"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="d-flex align-items-center text-gray-400 text-hover-primary mb-2" href="#">
                                <span class="svg-icon svg-icon-4 me-1"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="d-flex my-4">
                        <a id="kt_user_follow_button" class="btn btn-sm btn-light me-2" href="#">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr012.svg-->
                            <span class="svg-icon svg-icon-3 d-none"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10 18C9.7 18 9.5 17.9 9.3 17.7L2.3 10.7C1.9 10.3 1.9 9.7 2.3 9.3C2.7 8.9 3.29999 8.9 3.69999 9.3L10.7 16.3C11.1 16.7 11.1 17.3 10.7 17.7C10.5 17.9 10.3 18 10 18Z" fill="currentColor" opacity="0.3"></path>
                        ...
                        <a class="btn btn-sm btn-primary me-2" data-bs-target="#kt_modal_offer_a_deal" data-bs-toggle="modal" href="#">Hire Me</a>


                        <div class="me-0">
                            <button class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary" data-kt-menu-placement="bottom-end" data-kt-menu-trigger="click">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link px-3" href="#"> Create Invoice </a>
                                </div>
                                <!--end::Menu item-->

                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link flex-stack px-3" href="#">
                                        Create Payment

                                        <i aria-label="Specify a target name for future usage and reference" class="fas fa-exclamation-circle ms-2 fs-7" data-bs-original-title="Specify a target name for future usage and reference" data-bs-toggle="tooltip" data-kt-initialized="1"></i>
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link px-3" href="#"> Generate Bill </a>
                                </div>
                                <!--end::Menu item-->

                                <!--begin::Menu item-->
                                <div class="menu-item px-3" data-kt-menu-placement="right-end" data-kt-menu-trigger="hover">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3" href="#"> Plans </a>
                                        </div>
                                        <!--end::Menu item-->

                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3" href="#"> Billing </a>
                                        </div>
                                        <!--end::Menu item-->

                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a class="menu-link px-3" href="#"> Statements </a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content px-3">
                                                ...
                                                <label class="form-check form-switch form-check-custom form-check-solid">
                                                    <!--begin::Input-->
                                                    <input checked="checked" class="form-check-input w-30px h-20px" name="notifications" type="checkbox" value="1" />
                                                    <!--end::Input-->
                                ...
                                <div class="menu-item px-3 my-1">
                                    <a class="menu-link px-3" href="#"> Settings </a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu 3-->
                ...
                <div class="d-flex flex-wrap flex-stack">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="svg-icon svg-icon-3 svg-icon-success me-2"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                            <rect fill="currentColor" height="2" opacity="0.5" rx="1" transform="rotate(90 13 6)" width="13" x="13" y="6"></rect>
                                            <path d="M12.5657 8.56569L16.75 12.75C17.1642 13.1642 17.8358 13.1642 18.25 12.75C18.6642 12.3358 18.6642 11.6642 18.25 11.25L12.7071 5.70711C12.3166 5.31658 11.6834 5.31658 11.2929 5.70711L5.75 11.25C5.33579 11.6642 5.33579 12.3358 5.75 12.75C6.16421 13.1642 6.83579 13.1642 7.25 12.75L11.4343 8.56569C11.7467 8.25327 12.2533 8.25327 12.5657 8.56569Z" fill="currentColor"></path>
                                        </svg>
                                    </span>
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-prefix="$" data-kt-countup-value="4500" data-kt-initialized="1">
                                        $4,500
                                    </div>
                                </div>
                                <!--end::Number-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="svg-icon svg-icon-3 svg-icon-danger me-2"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                            <rect fill="currentColor" height="2" opacity="0.5" rx="1" transform="rotate(-90 11 18)" width="13" x="11" y="18"></rect>
                                            <path d="M11.4343 15.4343L7.25 11.25C6.83579 10.8358 6.16421 10.8358 5.75 11.25C5.33579 11.6642 5.33579 12.3358 5.75 12.75L11.2929 18.2929C11.6834 18.6834 12.3166 18.6834 12.7071 18.2929L18.25 12.75C18.6642 12.3358 18.6642 11.6642 18.25 11.25C17.8358 10.8358 17.1642 10.8358 16.75 11.25L12.5657 15.4343C12.2533 15.7467 11.7467 15.7467 11.4343 15.4343Z" fill="currentColor"></path>
                                        </svg>
                                    </span>
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-value="75" data-kt-initialized="1">
                                        75
                                    </div>
                                </div>
                                <!--end::Number-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bold counted" data-kt-countup="true" data-kt-countup-prefix="%" data-kt-countup-value="60" data-kt-initialized="1">
                                        %60
                                    </div>
                                </div>
                                <!--end::Number-->
                    ...
                    <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                        ...
                        <div class="h-5px mx-3 w-100 bg-light mb-3">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="bg-success rounded h-5px" role="progressbar" style="width: 50%"></div>
                        </div>
                    </div>
                    <!--end::Progress-->
                </div>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/overview.html">
                    Overview
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="@/../demo1/account/settings.html">
                    Settings
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/security.html">
                    Security
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/activity.html">
                    Activity
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/billing.html">
                    Billing
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/statements.html">
                    Statements
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/referrals.html">
                    Referrals
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/api-keys.html">
                    API Keys
                </a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="@/../demo1/account/logs.html">
                    Logs
                </a>
            </li>
            <!--end::Nav item-->
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('@/assets/media/svg/avatars/blank.svg')">
                            ...
                            <!--begin::Label-->
                            <label aria-label="Change avatar" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-bs-original-title="Change avatar" data-bs-toggle="tooltip" data-kt-image-input-action="change" data-kt-initialized="1">
                            ...
                            <!--begin::Cancel-->
                            <span aria-label="Cancel avatar" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-bs-original-title="Cancel avatar" data-bs-toggle="tooltip" data-kt-image-input-action="cancel" data-kt-initialized="1">
                                <i class="bi bi-x fs-2"></i>
                            </span>
                            <!--end::Cancel-->

                            <!--begin::Remove-->
                            <span aria-label="Remove avatar" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-bs-original-title="Remove avatar" data-bs-toggle="tooltip" data-kt-image-input-action="remove" data-kt-initialized="1">
                                <i class="bi bi-x fs-2"></i>
                            </span>
                            <!--end::Remove-->
                        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="fname" placeholder="First name" type="text" value="Max" />
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input class="form-control form-control-lg form-control-solid" name="lname" placeholder="Last name" type="text" value="Smith" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                        </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input class="form-control form-control-lg form-control-solid" name="company" placeholder="Company name" type="text" value="Keenthemes" />
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                        ...
                        <i aria-label="Phone number must be active" class="fas fa-exclamation-circle ms-1 fs-7" data-bs-original-title="Phone number must be active" data-bs-toggle="tooltip" data-kt-initialized="1"></i>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input class="form-control form-control-lg form-control-solid" name="phone" placeholder="Phone number" type="tel" value="044 3276 454 935" />
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input class="form-control form-control-lg form-control-solid" name="website" placeholder="Company website" type="text" value="keenthemes.com" />
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    ...
                    <label class="col-lg-4 col-form-label fw-semibold fs-6">
                        ...
                        <i aria-label="Country of origination" class="fas fa-exclamation-circle ms-1 fs-7" data-bs-original-title="Country of origination" data-bs-toggle="tooltip" data-kt-initialized="1"></i>
                    </label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select aria-hidden="true" aria-label="Select a Country" class="form-select form-select-solid form-select-lg fw-semibold select2-hidden-accessible" data-control="select2" data-kt-initialized="1" data-placeholder="Select a country..." data-select2-id="select2-data-10-2hun" name="country" tabindex="-1">
                            <option data-select2-id="select2-data-12-wztn" value="">
                                Select a Country...
                            </option>
                        ...
                        </select><span class="select2 select2-container select2-container--bootstrap5" data-select2-id="select2-data-11-l70w" dir="ltr" style="width: 100%"><span class="selection"><span aria-controls="select2-country-0i-container" aria-disabled="false" aria-expanded="false" aria-haspopup="true" aria-labelledby="select2-country-0i-container" class="select2-selection select2-selection--single form-select form-select-solid form-select-lg fw-semibold" role="combobox" tabindex="0"><span id="select2-country-0i-container" aria-readonly="true" class="select2-selection__rendered" role="textbox" title="Select a country..."><span class="select2-selection__placeholder">Select a country...</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span aria-hidden="true" class="dropdown-wrapper"></span></span>
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <!--begin::Input-->
                        <select aria-hidden="true" aria-label="Select a Language" class="form-select form-select-solid form-select-lg select2-hidden-accessible" data-control="select2" data-kt-initialized="1" data-placeholder="Select a language..." data-select2-id="select2-data-13-w983" name="language" tabindex="-1">
                            <option data-select2-id="select2-data-15-w02k" value="">
                                Select a Language...
                            </option>
                        ...
                        </select><span class="select2 select2-container select2-container--bootstrap5" data-select2-id="select2-data-14-2yyt" dir="ltr" style="width: 100%"><span class="selection"><span aria-controls="select2-language-1s-container" aria-disabled="false" aria-expanded="false" aria-haspopup="true" aria-labelledby="select2-language-1s-container" class="select2-selection select2-selection--single form-select form-select-solid form-select-lg" role="combobox" tabindex="0"><span id="select2-language-1s-container" aria-readonly="true" class="select2-selection__rendered" role="textbox" title="Select a language..."><span class="select2-selection__placeholder">Select a language...</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span aria-hidden="true" class="dropdown-wrapper"></span></span>
                        <!--end::Input-->
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select aria-hidden="true" aria-label="Select a Timezone" class="form-select form-select-solid form-select-lg select2-hidden-accessible" data-control="select2" data-kt-initialized="1" data-placeholder="Select a timezone.." data-select2-id="select2-data-16-2hpe" name="timezone" tabindex="-1">
                            <option data-select2-id="select2-data-18-bx6z" value="">
                                Select a Timezone..
                            </option>
                        ...
                        </select><span class="select2 select2-container select2-container--bootstrap5" data-select2-id="select2-data-17-qcf3" dir="ltr" style="width: 100%"><span class="selection"><span aria-controls="select2-timezone-e4-container" aria-disabled="false" aria-expanded="false" aria-haspopup="true" aria-labelledby="select2-timezone-e4-container" class="select2-selection select2-selection--single form-select form-select-solid form-select-lg" role="combobox" tabindex="0"><span id="select2-timezone-e4-container" aria-readonly="true" class="select2-selection__rendered" role="textbox" title="Select a timezone.."><span class="select2-selection__placeholder">Select a timezone..</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span aria-hidden="true" class="dropdown-wrapper"></span></span>
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row">
                        <select aria-hidden="true" aria-label="Select a Currency" class="form-select form-select-solid form-select-lg select2-hidden-accessible" data-control="select2" data-kt-initialized="1" data-placeholder="Select a currency.." data-select2-id="select2-data-19-8hlp" name="currnecy" tabindex="-1">
                            <option data-select2-id="select2-data-21-wirw" value="">
                                Select a currency..
                            </option>
                        ...
                        </select><span class="select2 select2-container select2-container--bootstrap5" data-select2-id="select2-data-20-r9sz" dir="ltr" style="width: 100%"><span class="selection"><span aria-controls="select2-currnecy-4y-container" aria-disabled="false" aria-expanded="false" aria-haspopup="true" aria-labelledby="select2-currnecy-4y-container" class="select2-selection select2-selection--single form-select form-select-solid form-select-lg" role="combobox" tabindex="0"><span id="select2-currnecy-4y-container" aria-readonly="true" class="select2-selection__rendered" role="textbox" title="Select a currency.."><span class="select2-selection__placeholder">Select a currency..</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span aria-hidden="true" class="dropdown-wrapper"></span></span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                            <input id="allowmarketing" checked="" class="form-check-input w-45px h-30px" type="checkbox" />
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <button class="btn btn-light btn-active-light-primary me-2" type="reset">
                    Discard
                </button>

                <button id="kt_account_profile_details_submit" class="btn btn-primary" type="submit">
                    Save Changes
                </button>
            </div>
            <!--end::Actions-->
...
<div class="card mb-5 mb-xl-10">
    <!--begin::Card header-->
    <div class="card-header border-0 cursor-pointer" data-bs-target="#kt_account_signin_method" data-bs-toggle="collapse" role="button">
        <div class="card-title m-0">
    ...
    <div id="kt_account_settings_signin_method" class="collapse show">
        ...
        <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label class="form-label fs-6 fw-bold mb-3" for="emailaddress">Enter New Email Address</label>
                                    <input id="emailaddress" class="form-control form-control-lg form-control-solid" name="emailaddress" placeholder="Email Address" type="email" value="support@keenthemes.com" />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label class="form-label fs-6 fw-bold mb-3" for="confirmemailpassword">Confirm Password</label>
                                    <input id="confirmemailpassword" class="form-control form-control-lg form-control-solid" name="confirmemailpassword" type="password" />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex">
                            <button id="kt_signin_submit" class="btn btn-primary me-2 px-6" type="button">
                                Update Email
                            </button>
                            <button id="kt_signin_cancel" class="btn btn-color-gray-400 btn-active-light-primary px-6" type="button">
                                Cancel
                            </button>
                        </div>
                    </form>
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    ...
                    <form id="kt_signin_change_password" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                        <div class="row mb-1">
                            <div class="col-lg-4">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label class="form-label fs-6 fw-bold mb-3" for="currentpassword">Current Password</label>
                                    <input id="currentpassword" class="form-control form-control-lg form-control-solid" name="currentpassword" type="password" />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label class="form-label fs-6 fw-bold mb-3" for="newpassword">New Password</label>
                                    <input id="newpassword" class="form-control form-control-lg form-control-solid" name="newpassword" type="password" />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="fv-row mb-0 fv-plugins-icon-container">
                                    <label class="form-label fs-6 fw-bold mb-3" for="confirmpassword">Confirm New Password</label>
                                    <input id="confirmpassword" class="form-control form-control-lg form-control-solid" name="confirmpassword" type="password" />
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex">
                            <button id="kt_password_submit" class="btn btn-primary me-2 px-6" type="button">
                                Update Password
                            </button>
                            <button id="kt_password_cancel" class="btn btn-color-gray-400 btn-active-light-primary px-6" type="button">
                                Cancel
                            </button>
                        </div>
                    </form>
            ...
            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                ...
                <span class="svg-icon svg-icon-2tx svg-icon-primary me-4"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20.5543 4.37824L12.1798 2.02473C12.0626 1.99176 11.9376 1.99176 11.8203 2.02473L3.44572 4.37824C3.18118 4.45258 3 4.6807 3 4.93945V13.569C3 14.6914 3.48509 15.8404 4.4417 16.984C5.17231 17.8575 6.18314 18.7345 7.446 19.5909C9.56752 21.0295 11.6566 21.912 11.7445 21.9488C11.8258 21.9829 11.9129 22 12.0001 22C12.0872 22 12.1744 21.983 12.2557 21.9488C12.3435 21.912 14.4326 21.0295 16.5541 19.5909C17.8169 18.7345 18.8277 17.8575 19.5584 16.984C20.515 15.8404 21 14.6914 21 13.569V4.93945C21 4.6807 20.8189 4.45258 20.5543 4.37824Z" fill="currentColor" opacity="0.3"></path>
                ...
                <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                    ...
                    <!--begin::Action-->
                    <a class="btn btn-primary px-6 align-self-center text-nowrap" data-bs-target="#kt_modal_two_factor_authentication" data-bs-toggle="modal" href="#">
                        Enable
                    </a>
                    <!--end::Action-->
                </div>
...
<div class="card mb-5 mb-xl-10">
    <!--begin::Card header-->
    <div aria-controls="kt_account_connected_accounts" aria-expanded="true" class="card-header border-0 cursor-pointer" data-bs-target="#kt_account_connected_accounts" data-bs-toggle="collapse" role="button">
        <div class="card-title m-0">
    ...
    <div id="kt_account_settings_connected_accounts" class="collapse show">
        ...
        <div class="card-body border-top p-9">
            ...
            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
                ...
                <span class="svg-icon svg-icon-2tx svg-icon-primary me-4"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22 19V17C22 16.4 21.6 16 21 16H8V3C8 2.4 7.6 2 7 2H5C4.4 2 4 2.4 4 3V19C4 19.6 4.4 20 5 20H21C21.6 20 22 19.6 22 19Z" fill="currentColor" opacity="0.3"></path>
            ...
            <div class="py-2">
                ...
                <div class="d-flex flex-stack">
                    <div class="d-flex">
                        <img alt="" class="w-30px me-6" src="@/assets/media/svg/brand-logos/google-icon.svg" />

                        <div class="d-flex flex-column">
                            <a class="fs-5 text-dark text-hover-primary fw-bold" href="#">Google</a>
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="form-check form-check-solid form-check-custom form-switch">
                            <input id="googleswitch" checked="" class="form-check-input w-45px h-30px" type="checkbox" />
                ...
                <div class="d-flex flex-stack">
                    <div class="d-flex">
                        <!--              <img alt="" class="w-30px me-6" src="@/assets/media/svg/brand-logos/github.svg">-->

                        <div class="d-flex flex-column">
                            <a class="fs-5 text-dark text-hover-primary fw-bold" href="#">Github</a>
                            <div class="fs-6 fw-semibold text-gray-400">
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="form-check form-check-solid form-check-custom form-switch">
                            <input id="githubswitch" checked="" class="form-check-input w-45px h-30px" type="checkbox" />
                ...
                <div class="d-flex flex-stack">
                    <div class="d-flex">
                        <!--              <img alt="" class="w-30px me-6" src="@/assets/media/svg/brand-logos/slack-icon.svg">-->

                        <div class="d-flex flex-column">
                            <a class="fs-5 text-dark text-hover-primary fw-bold" href="#">Slack</a>
                            <div class="fs-6 fw-semibold text-gray-400">
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="form-check form-check-solid form-check-custom form-switch">
                            <input id="slackswitch" class="form-check-input w-45px h-30px" type="checkbox" />
...
<div class="card mb-5 mb-xl-10">
    <!--begin::Card header-->
    <div aria-controls="kt_account_email_preferences" aria-expanded="true" class="card-header border-0 cursor-pointer" data-bs-target="#kt_account_email_preferences" data-bs-toggle="collapse" role="button">
        <div class="card-title m-0">
        ...
        <form class="form">
            ...
            <div class="card-body border-top px-9 py-9">
                ...
                <label class="form-check form-check-custom form-check-solid align-items-start">
                    <!--begin::Input-->
                    <input class="form-check-input me-3" name="email-preferences[]" type="checkbox" value="1" />
                    <!--end::Input-->
                ...
                <label class="form-check form-check-custom form-check-solid align-items-start">
                    <!--begin::Input-->
                    <input checked="checked" class="form-check-input me-3" name="email-preferences[]" type="checkbox" value="1" />
                    <!--end::Input-->
                ...
                <label class="form-check form-check-custom form-check-solid align-items-start">
                    ...
                    <span class="form-check-label d-flex flex-column align-items-start">
                        ...
                        <span class="text-muted fs-6">Receive a notification if a payment is disputed by a customer and for
                ...
                <label class="form-check form-check-custom form-check-solid align-items-start">
                    ...
                    <span class="form-check-label d-flex flex-column align-items-start">
                        ...
                        <span class="text-muted fs-6">Receive a notification if a payment is stated as risk by the Finance
                            Department.</span>
                    </span>
                    <!--end::Label-->
                </label>
                ...
                <label class="form-check form-check-custom form-check-solid align-items-start">
                    ...
                    <span class="form-check-label d-flex flex-column align-items-start">
                        ...
                        <span class="text-muted fs-6">Receive a notification if a customer sends an incorrect amount to pay
                            their invoice.</span>
                    </span>
                    <!--end::Label-->
                </label>
...
<div class="card mb-5 mb-xl-10">
    <!--begin::Card header-->
    <div aria-controls="kt_account_notifications" aria-expanded="true" class="card-header border-0 cursor-pointer" data-bs-target="#kt_account_notifications" data-bs-toggle="collapse" role="button">
        <div class="card-title m-0">
                    ...
                    <table class="table table-row-dashed border-gray-300 align-middle gy-6">
                        <tbody class="fs-6 fw-semibold">
                            ...
                            <tr>
                                ...
                                <td class="w-125px">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="kt_settings_notification_email" checked="" class="form-check-input" data-kt-check="true" data-kt-check-target="[data-kt-settings-notification=email]" type="checkbox" value="" />
                                ...
                                <td class="w-125px">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="kt_settings_notification_phone" checked="" class="form-check-input" data-kt-check="true" data-kt-check-target="[data-kt-settings-notification=phone]" type="checkbox" value="" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="billing1" checked="" class="form-check-input" data-kt-settings-notification="email" type="checkbox" value="1" />
                                        <label class="form-check-label ps-2" for="billing1"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="billing2" checked="" class="form-check-input" data-kt-settings-notification="phone" type="checkbox" value="" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="team1" checked="" class="form-check-input" data-kt-settings-notification="email" type="checkbox" value="" />
                                        <label class="form-check-label ps-2" for="team1"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="team2" class="form-check-input" data-kt-settings-notification="phone" type="checkbox" value="" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="project1" class="form-check-input" data-kt-settings-notification="email" type="checkbox" value="" />
                                        <label class="form-check-label ps-2" for="project1"></label>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="project2" checked="" class="form-check-input" data-kt-settings-notification="phone" type="checkbox" value="" />
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="newsletter1" class="form-check-input" data-kt-settings-notification="email" type="checkbox" value="" />
                                        <label class="form-check-label ps-2" for="newsletter1"></label>
                                    </div>
                                </td>
                                <td class="border-bottom-0">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input id="newsletter2" class="form-check-input" data-kt-settings-notification="phone" type="checkbox" value="" />
...
<div class="card">
    <!--begin::Card header-->
    <div aria-controls="kt_account_deactivate" aria-expanded="true" class="card-header border-0 cursor-pointer" data-bs-target="#kt_account_deactivate" data-bs-toggle="collapse" role="button">
        <div class="card-title m-0">
        ...
        <form id="kt_account_deactivate_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <span class="svg-icon svg-icon-2tx svg-icon-warning me-4"><svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                            <rect fill="currentColor" height="20" opacity="0.3" rx="10" width="20" x="2" y="2"></rect>
                            <rect fill="currentColor" height="2" rx="1" transform="rotate(-90 11 14)" width="7" x="11" y="14"></rect>
                            <rect fill="currentColor" height="2" rx="1" transform="rotate(-90 11 17)" width="2" x="11" y="17"></rect>
                        </svg>
                    </span>
                    <!--end::Svg Icon-->
                    <!--end::Icon-->
                    ...
                    <div class="d-flex flex-stack flex-grow-1">
                        ...
                        <div class="fw-semibold">
                            ...
                            <div class="fs-6 text-gray-700">
                                ...
                                number when you reset yousignr password. <br /><a class="fw-bold" href="#">Learn more</a>
                            </div>
                        </div>
                        <!--end::Content-->
                    </div>
                ...
                <div class="form-check form-check-solid fv-row fv-plugins-icon-container">
                    <input id="deactivate" class="form-check-input" name="deactivate" type="checkbox" value="" />
            ...
            <!--begin::Card footer-->
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <button id="kt_account_deactivate_account_submit" class="btn btn-danger fw-semibold" type="submit">
                    Deactivate Account
                </button>
            </div>
            <!--end::Card footer-->
