        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                ...
                <div class="card-body d-flex align-items-end pt-0">
                    @include('layouts.widgets.progress')
                </div>
                <!--end::Card body-->
            </div>
            <!--end::Card widget 20-->
            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                ...
                <div class="card-body d-flex flex-column justify-content-end pe-0">
                    ...
                    <!--begin::Users group-->
                    <div style="display:none;" class="symbol-group symbol-hover flex-nowrap">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="badge badge-light-success fs-base">
                                ...
                                <span class="svg-icon svg-icon-5 svg-icon-success ms-n1"><svg width="24" height="24"
                                                                                              viewBox="0 0 24 24"
                                                                                              fill="none"
                            ...
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <rect x="21.9497" y="3.46448" width="13" height="2" rx="1"
                                          transform="rotate(135 21.9497 3.46448)" fill="currentColor"></rect>
                                    <path
        ...
        <div class="col-xxl-6">
            ...
            <div class="card card-flush h-md-100">
                ...
                <div
                    ...
                    style="background-position: 100% 50%; background-image:url('{{asset('assets/media/stock/900x600/46.jpg')}}')">
                    <!--begin::Wrapper-->
                    <div class="mb-10">
                        <!--begin::Title-->
