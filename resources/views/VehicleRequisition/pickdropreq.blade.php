<html lang="en" class="wf-nunitosans-n2-active wf-nunitosans-i2-active wf-nunitosans-n3-active wf-nunitosans-i3-active wf-nunitosans-n4-active wf-nunitosans-i4-active wf-nunitosans-n6-active wf-nunitosans-i6-active wf-nunitosans-n7-active wf-nunitosans-i7-active wf-nunitosans-n8-active wf-nunitosans-i8-active wf-nunitosans-n9-active wf-active"><head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito+Sans:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i&amp;display=swap" media="all"><script>
        WebFont.load({
            google: {
    ...
    <script>
        ...
        @keyframes chartjs-render-animation{from{opacity:.99}to{opacity:1}}.chartjs-render-monitor{animation:chartjs-render-animation 1ms}.chartjs-size-monitor,.chartjs-size-monitor-expand,.chartjs-size-monitor-shrink{position:absolute;direction:ltr;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1}.chartjs-size-monitor-expand>div{position:absolute;width:1000000px;height:1000000px;left:0;top:0}.chartjs-size-monitor-shrink>div{position:absolute;width:200%;height:200%;left:0;top:0}</style><style type="text/css">.jqstooltip { position: absolute;left: 0px;top: 0px;visibility: hidden;background: rgb(0, 0, 0) transparent;background-color: rgba(0,0,0,0.6);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000);-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000)";color: white;font: 10px arial, san serif;text-align: left;white-space: nowrap;padding: 5px;border: 1px solid white;z-index: 10000;}.jqsfield { color: white;font: 10px arial, san serif;text-align: left;}</style></head>
    ...
    <nav class="sidebar sidebar-bunker">
        ...
        <div class="sidebar-body ps ps--active-y">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    <li class="">
                        <a href="https://vmsdemo.bdtask-demo.com/dashboard/home" aria-expanded="false"><i class="typcn typcn-home-outline mr-2"></i> Dashboard</a>
                    </li>
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><div class="material-ink animate" style="height: 220px; width: 220px; top: -80px; left: 85px;"></div><i class="typcn icon-default typcn-group-outline mr-2"></i>Employee Management</a>
                        <ul class="nav-second-level mm-collapse" style="height: 0px;">


                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Employees/index')" aria-expanded="true">Manage Employee</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Employees/create_position')" aria-expanded="false">Position</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Department_controller/dept_view')" aria-expanded="false">Department</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Driver_controller/index')" aria-expanded="false">Manage Driver</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Driver_controller/licensetypelist')" aria-expanded="false">Manage License</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Driver_controller/performancelist')" aria-expanded="false">Driver Performance</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/employeeManagement/Approval_list/index')" aria-expanded="false">Manage Req. Approval</a>
                            </li>
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><div class="material-ink animate" style="height: 220px; width: 220px; top: -87px; left: 81px;"></div><i class="typcn icon-default typcn-social-dribbble mr-2"></i>Vehicle Management</a>
                        <ul class="nav-second-level mm-collapse" style="height: 0px;">


                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleManagement/Vehicle_management/index')" aria-expanded="false">Manage Vehicle</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleManagement/Vehicle_management/insurancelist')" aria-expanded="false">Insurance Details</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleManagement/Vehicle_management/legaldocumentlist')" aria-expanded="false">Manage Legal Document</a>
                            </li>

                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleManagement/Vehicle_management/managereminder')" aria-expanded="true">Reminder Details</a>
                            </li>
                    ...
                    <li class="mm-active">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="true"><div class="material-ink animate" style="height: 220px; width: 220px; top: -83px; left: 28px;"></div><i class="typcn icon-default typcn-eject-outline mr-2"></i>Vehicle Requisition</a>
                        <ul class="nav-second-level mm-collapse mm-show" style="">


                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/index')" aria-expanded="false">Manage Vehicle Requisition</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/vehicleroute')" aria-expanded="false">Vehicle Route Details</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/approvalauthority')" aria-expanded="false">Manage Approval Authority</a>
                            </li>

                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/pickdropreq')" aria-expanded="true">Pick &amp; Drop Requisition List</a>
                            </li>
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><i class="typcn icon-default typcn-compass mr-2"></i>Maintenance</a>
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><i class="typcn icon-default typcn-ticket mr-2"></i>Cost &amp; Inventory</a>
                        <ul class="nav-second-level mm-collapse">
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><i class="typcn icon-default typcn-ticket mr-2"></i>Purchase &amp; Usage</a>
                        <ul class="nav-second-level mm-collapse">
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><i class="typcn icon-default typcn-arrow-sync-outline mr-2"></i>Refueling</a>
                        <ul class="nav-second-level mm-collapse">
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><i class="typcn icon-default typcn-chart-area-outline mr-2"></i>Reports</a>
                        <ul class="nav-second-level mm-collapse">
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><i class="typcn icon-default typcn-cog-outline mr-2"></i>Setting</a>
                        <ul class="nav-second-level mm-collapse">
                    ...
                    <li class=""><a href="https://vmsdemo.bdtask-demo.com/dashboard/language" aria-expanded="false"><i class="typcn icon-default typcn-flag-outline mr-2"></i>
                            Language</a></li>
                    <li class=""><a href="https://vmsdemo.bdtask-demo.com/dashboard/setting" aria-expanded="false"><i class="typcn icon-default typcn-cog-outline mr-2"></i>
                            Application Setting</a></li>
                </ul>
            </nav>
            <div class="ps__rail-x" style="left: 0px; top: 62px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 62px; height: 245px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 18px; height: 74px;"></div></div></div> </nav>

    <div class="content-wrapper">
        <div class="main-content position-relative">
            <div class="page-loader-wrapper content-loder" style="display: none;">
                <div class="loader">
                    <div class="preloader">
                        <div class="spinner-layer pl-green">
                            <div class="circle-clipper left">
                ...
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="nav-clock">
                        <div class="time">
                            ...
                            <span class="time-min">27</span>
                            <span class="time-sec">27</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="body-content" id="bodycontent"><div id="add0" class="modal fade bd-example-modal-lg" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/add_pickdropreq" id="emp_form" class="row" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group row">
                                            <label for="route" class="col-sm-3 col-form-label">Route <i class="text-danger"> <i class="text-danger">*</i></i></label>
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="route" id="route" onchange="getpoint()" data-select2-id="route" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="354">Please Select One</option>
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="353" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-route-container"><span class="select2-selection__rendered" id="select2-route-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="requiest_by" id="requiest_by" data-select2-id="requiest_by" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="356">Select Employee</option>
                                                    <option value="6">
                                                        Kamrul_(ACCOUNTING_ETMYQ36Y) </option>
                                                    <option value="11">
                                                        dsfdf_(Human Resource_ESQ0BXI9) </option>
                                                    <option value="14">
                                                    ...
                                                    <option value="3">
                                                        Jubaer Hossain_(Human Resource_E1RTC20Y) </option>
                                                    <option value="4">
                                                        Rashid_(Human Resource_E0CRB403) </option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="355" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-requiest_by-container"><span class="select2-selection__rendered" id="select2-requiest_by-container" role="textbox" aria-readonly="true" title="Select Employee">Select Employee</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form action="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/pickdropreq" class="form-inline row" id="validate" method="post" accept-charset="utf-8">
                                    <div class="col-sm-12 col-xl-4">
                                        <div class="form-group row mb-1">
                                            <label for="routesr" class="col-sm-5 col-form-label justify-content-start text-left">Route </label>
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" name="routesr" id="routesr" data-select2-id="routesr" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="358">Please Select One</option>
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="357" style="width: 207px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-routesr-container"><span class="select2-selection__rendered" id="select2-routesr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="req_typesr" class="col-sm-5 col-form-label justify-content-start text-left">Requisition Type </label>
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" name="req_typesr" id="req_typesr" data-select2-id="req_typesr" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="363">Please Select One</option>
                                                    ...
                                                    <option value="Pick Up">
                                                        Pick Up</option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="362" style="width: 166px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-req_typesr-container"><span class="select2-selection__rendered" id="select2-req_typesr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-xl-4">
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" name="requiest_bysr" id="requiest_bysr" data-select2-id="requiest_bysr" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="365">Please Select One</option>
                                                    <option value="Specific Day">Specific Day </option>
                                                    <option value="Regular">Regular </option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="364" style="width: 161px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-requiest_bysr-container"><span class="select2-selection__rendered" id="select2-requiest_bysr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                    ...
                                    <div class="col-sm-12 col-xl-4">
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" name="statussr" id="statussr" data-select2-id="statussr" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="367">Please Select One</option>
                                                    <option value="pending">Pending</option>
                                                    <option value="release">Release</option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="366" style="width: 161px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-statussr-container"><span class="select2-selection__rendered" id="select2-statussr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group row  mb-1">
                                            ...
                                            <div class="col-sm-7 text-right">
                                                <button type="button" class="btn btn-success" id="pichdropreq">Search</button>&nbsp;
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="vreqpickdrop_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group">          <button class="btn btn-secondary buttons-copy buttons-html5 btn-success" tabindex="0" aria-controls="vreqpickdrop" type="button"><span>Copy</span></button> <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0" aria-controls="vreqpickdrop" type="button"><span>Excel</span></button> <button class="btn btn-secondary buttons-pdf buttons-html5 btn-success" tabindex="0" aria-controls="vreqpickdrop" type="button"><span>PDF</span></button> <button class="btn btn-secondary buttons-print btn-success" tabindex="0" aria-controls="vreqpickdrop" type="button"><span>Print</span></button> <div class="btn-group"><button class="btn btn-secondary buttons-collection dropdown-toggle buttons-colvis btn-success" tabindex="0" aria-controls="vreqpickdrop" type="button" aria-haspopup="true" aria-expanded="false"><span>Column visibility</span></button></div> </div></div><div class="col-lg-6 col-md-12"><div id="vreqpickdrop_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="vreqpickdrop"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="vreqpickdrop" class="table display table-bordered table-striped table-hover dataTable no-footer" role="grid" aria-describedby="vreqpickdrop_info" style="width: 1065px;">
                                                    <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-sort="ascending" aria-label="SL: activate to sort column descending" style="width: 32px;">SL</th><th class="sorting" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-label="Route: activate to sort column ascending" style="width: 184px;">Route</th><th class="sorting" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-label="Requisition Date: activate to sort column ascending" style="width: 147px;">Requisition Date</th><th class="sorting" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-label="Requisition Type: activate to sort column ascending" style="width: 147px;">Requisition Type</th><th class="sorting" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-label="Requested By : activate to sort column ascending" style="width: 124px;">Requested By </th><th class="sorting" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 64px;">Status</th><th class="sorting" tabindex="0" aria-controls="vreqpickdrop" rowspan="1" colspan="1" aria-label="Action: activate to sort column ascending" style="width: 109px;">Action</th></tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr role="row" class="odd"><td class="sorting_1">1</td><td>Jatrabari to Uttara</td><td>2019-08-29</td><td>Pick Up &amp; Drop Off</td><td>Specific Day</td><td>Pending</td><td><input name="url" type="hidden" id="url_3" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(3)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/3" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                            ...
                                                            </div></td></tr><tr role="row" class="even"><td class="sorting_1">2</td><td>Mohammanpur to khilgao</td><td>2019-09-07</td><td>Drop Off</td><td>Regular</td><td>Release</td><td><input name="url" type="hidden" id="url_4" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(4)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/4" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="odd"><td class="sorting_1">3</td><td>gabtoli to motijeel</td><td>2019-11-17</td><td>Pick Up &amp; Drop Off</td><td>Regular</td><td>Release</td><td><input name="url" type="hidden" id="url_5" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(5)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/5" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="even"><td class="sorting_1">4</td><td>Route1</td><td>2021-02-12</td><td>Pick Up</td><td>Specific Day</td><td>Release</td><td><input name="url" type="hidden" id="url_6" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(6)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/6" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="odd"><td class="sorting_1">5</td><td>dhaka to chottogram</td><td>2021-02-23</td><td>Drop Off</td><td>Specific Day</td><td>Release</td><td><input name="url" type="hidden" id="url_7" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(7)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/7" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="even"><td class="sorting_1">6</td><td>Route1</td><td>2021-02-23</td><td>Pick Up &amp; Drop Off</td><td>Regular</td><td>Release</td><td><input name="url" type="hidden" id="url_8" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(8)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/8" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="odd"><td class="sorting_1">7</td><td>ddd</td><td>2023-01-25</td><td>Pick Up</td><td>Regular</td><td>Pending</td><td><input name="url" type="hidden" id="url_9" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(9)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/9" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="even"><td class="sorting_1">8</td><td>Jatra Bari</td><td>2023-02-02</td><td>Pick Up &amp; Drop Off</td><td>Specific Day</td><td>Pending</td><td><input name="url" type="hidden" id="url_10" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(10)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/10" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="odd"><td class="sorting_1">9</td><td>Jatra Bari</td><td>2023-02-18</td><td>Pick Up &amp; Drop Off</td><td>Specific Day</td><td>Pending</td><td><input name="url" type="hidden" id="url_12" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(12)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/12" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            </div></td></tr><tr role="row" class="even"><td class="sorting_1">10</td><td>qwerty</td><td>2023-02-18</td><td>Drop Off</td><td>Regular</td><td>Pending</td><td><input name="url" type="hidden" id="url_13" value="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/updatepickdropreqfrm"><a onclick="editinfo(13)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/vehicleRequisition/Vehicle_requisition/delete_pickdropreq/13" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a><div class="text-right" style="display:inline-block;">
                                                                <div class="actions" style="display:inline-block;">
                                                                    <div class="dropdown action-item" data-toggle="dropdown">
                                                                        <a href="#" class="action-item"><i class="ti-more-alt"></i></a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                </table><div id="vreqpickdrop_processing" class="dataTables_processing card" style="display: none;">Processing...</div></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="vreqpickdrop_info" role="status" aria-live="polite">Showing 1 to 10 of 10 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="vreqpickdrop_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="vreqpickdrop_previous"><a href="#" aria-controls="vreqpickdrop" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="vreqpickdrop" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="vreqpickdrop_next"><a href="#" aria-controls="vreqpickdrop" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/vehicleRequisition_pickdropreq_list.js"></script></div>
