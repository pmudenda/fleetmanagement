                ...
                <ul class="metismenu">
                    ...
                    <li class="mm-active">
                        ...
                        <ul class="nav-second-level mm-collapse mm-show" style="">
                            ...
                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/refueling/Refueling/fuelstation')" aria-expanded="true">Manage Fuel Station </a>
                            </li>
                ...
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="nav-clock">
                        <div class="time">
                            ...
                            <span class="time-min">46</span>
                            <span class="time-sec">16</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="https://vmsdemo.bdtask-demo.com/refueling/refueling/add_refuelstation" id="emp_form" class="row" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group row">
                                            <label for="req_for" class="col-sm-5 col-form-label">Vendor Name <i class="text-danger">*</i></label>
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="vendor_name" id="vendor_name" data-select2-id="vendor_name" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="464">Please Select One</option>
                                                    <option value="Pakistan Railways">Pakistan Railways </option>
                                                    <option value="Auto Parts">Auto Parts </option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="463" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-vendor_name-container"><span class="select2-selection__rendered" id="select2-vendor_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        ...
                                        <div class="form-group row m-0">
                                            ...
                                            <div class="col-sm-7 checkbox checkbox-primary">
                                                <input id="checkbox2" type="checkbox" name="is_authrize">
                            ...
                            <div class="card-body row">
                                <div class="col-sm-12 col-xl-4">
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control basic-single select2-hidden-accessible" name="station_namesr" id="station_namesr" data-select2-id="station_namesr" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="466">Please Select One</option>
                                            ...
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="465" style="width: 330.656px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-station_namesr-container"><span class="select2-selection__rendered" id="select2-station_namesr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-xl-4">
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control basic-single select2-hidden-accessible" name="vendorsr" id="vendorsr" data-select2-id="vendorsr" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="470">Please Select One</option>
                                                <option value="Pakistan Railways">Pakistan Railways </option>
                                                <option value="Auto Parts">Auto Parts </option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="469" style="width: 330.656px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-vendorsr-container"><span class="select2-selection__rendered" id="select2-vendorsr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-xl-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="stationinfo_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group">          <button class="btn btn-secondary buttons-copy buttons-html5 btn-success" tabindex="0" aria-controls="stationinfo" type="button"><span>Copy</span></button> <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0" aria-controls="stationinfo" type="button"><span>Excel</span></button> <button class="btn btn-secondary buttons-pdf buttons-html5 btn-success" tabindex="0" aria-controls="stationinfo" type="button"><span>PDF</span></button> <button class="btn btn-secondary buttons-print btn-success" tabindex="0" aria-controls="stationinfo" type="button"><span>Print</span></button> <div class="btn-group"><button class="btn btn-secondary buttons-collection dropdown-toggle buttons-colvis btn-success" tabindex="0" aria-controls="stationinfo" type="button" aria-haspopup="true" aria-expanded="false"><span>Column visibility</span></button></div> </div></div><div class="col-lg-6 col-md-12"><div id="stationinfo_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="stationinfo"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="stationinfo" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" role="grid" aria-describedby="stationinfo_info" style="width: 1545px;">
                                                    <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 77px;" aria-sort="ascending" aria-label="SL: activate to sort column descending">SL</th><th class="sorting" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 266px;" aria-label="Station Name: activate to sort column ascending">Station Name</th><th class="sorting" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 229px;" aria-label="Vendor Name: activate to sort column ascending">Vendor Name</th><th class="sorting" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 278px;" aria-label="Authorize Person: activate to sort column ascending">Authorize Person</th><th class="sorting" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 267px;" aria-label="Contact Number: activate to sort column ascending">Contact Number</th><th class="sorting" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 206px;" aria-label="Is Authorize: activate to sort column ascending">Is Authorize</th><th class="sorting" tabindex="0" aria-controls="stationinfo" rowspan="1" colspan="1" style="width: 0px;" aria-label="Action: activate to sort column ascending">Action</th></tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr role="row" class="odd"><td class="sorting_1" tabindex="0">1</td><td>GM Filling Station</td><td>Honda</td><td>Jaman</td><td>0172345600</td><td>Yes</td><td style=""><input name="url" type="hidden" id="url_1" value="https://vmsdemo.bdtask-demo.com/refueling/refueling/updaterefuelstfrm"><a onclick="editinfo(1)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/refueling/refueling/delete_refuelst/1" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">2</td><td>Khalek filling Station</td><td>Honda</td><td>Khalek</td><td>01723456001</td><td>No</td><td style=""><input name="url" type="hidden" id="url_2" value="https://vmsdemo.bdtask-demo.com/refueling/refueling/updaterefuelstfrm"><a onclick="editinfo(2)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/refueling/refueling/delete_refuelst/2" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">3</td><td> cvbc</td><td>vandor</td><td>rtytryrtyyy</td><td>464564654</td><td>No</td><td style=""><input name="url" type="hidden" id="url_4" value="https://vmsdemo.bdtask-demo.com/refueling/refueling/updaterefuelstfrm"><a onclick="editinfo(4)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/refueling/refueling/delete_refuelst/4" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr></tbody>
                                                </table><div id="stationinfo_processing" class="dataTables_processing card" style="display: none;">Processing...</div></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="stationinfo_info" role="status" aria-live="polite">Showing 1 to 3 of 3 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="stationinfo_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="stationinfo_previous"><a href="#" aria-controls="stationinfo" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="stationinfo" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="stationinfo_next"><a href="#" aria-controls="stationinfo" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/fuelstation_list.js"></script></div>
