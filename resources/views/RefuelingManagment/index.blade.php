        ...
        <div class="sidebar-body ps ps--active-y">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><div class="material-ink animate" style="height: 220px; width: 220px; top: -90px; left: 28px;"></div><i class="typcn icon-default typcn-compass mr-2"></i>Maintenance</a>
                        <ul class="nav-second-level mm-collapse" style="height: 0px;">


                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/maintenance/Maintenance/index')" aria-expanded="false">Maintenance Req. Details</a>
                            </li>
                            ...
                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/maintenance/Maintenance/maintenanceservice')" aria-expanded="true">Maintenance Service List</a>
                            </li>
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><div class="material-ink animate" style="height: 220px; width: 220px; top: -90px; left: 88px;"></div><i class="typcn icon-default typcn-ticket mr-2"></i>Cost &amp; Inventory</a>
                        <ul class="nav-second-level mm-collapse" style="height: 0px;">


                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/index')" aria-expanded="false">Manage Expense Type</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/partslist')" aria-expanded="false">Manage Parts</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/categorylist')" aria-expanded="false">Category</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/locationlist')" aria-expanded="false">Location</a>
                            </li>

                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/costManagement/costManagement/stocklist')" aria-expanded="true">Stock Management</a>
                            </li>
                    ...
                    <li class="">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="false"><div class="material-ink animate" style="height: 220px; width: 220px; top: -84px; left: 0px;"></div><i class="typcn icon-default typcn-ticket mr-2"></i>Purchase &amp; Usage</a>
                        <ul class="nav-second-level mm-collapse" style="height: 0px;">


                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/purchase/Purchase/index')" aria-expanded="false">Purchase Details</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/purchase/Purchase/addpurchase')" aria-expanded="false">Add Purchase</a>
                            </li>

                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/purchase/Purchase/partsuse')" aria-expanded="true">Parts Usages List</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/purchase/Purchase/addusages')" aria-expanded="false">Add Parts Usage</a>
                            </li>
                    ...
                    <li class="mm-active">
                        <a class="has-arrow material-ripple" href="#" aria-expanded="true"><div class="material-ink animate" style="height: 220px; width: 220px; top: -93px; left: -26px;"></div><i class="typcn icon-default typcn-arrow-sync-outline mr-2"></i>Refueling</a>
                        <ul class="nav-second-level mm-collapse mm-show" style="">


                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/refueling/Refueling/index')" aria-expanded="false">Refuel Setting</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/refueling/Refueling/fuelstation')" aria-expanded="false">Manage Fuel Station </a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/refueling/Refueling/refuelrequisition')" aria-expanded="false">Refuel Requisition Details</a>
                            </li>

                            <li class="">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/refueling/Refueling/refuelapproval_authority')" aria-expanded="false">Manage Approval Authority</a>
                            </li>
            ...
            <div class="ps__rail-x" style="left: 0px; top: 133px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 133px; height: 509px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 100px; height: 386px;"></div></div></div> </nav>
                ...
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="nav-clock">
                        <div class="time">
                            ...
                            <span class="time-min">45</span>
                            <span class="time-sec">41</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="https://vmsdemo.bdtask-demo.com/refueling/refueling/add_refuelsetting" id="emp_form" class="row" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group row">
                                            <label for="vehicle_name" class="col-sm-5 col-form-label">Vehicle Name <i class="text-danger">*</i></label>
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="vehicle_name" id="vehicle_name" data-select2-id="vehicle_name" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="445">Please Select One</option>
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="444" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-vehicle_name-container"><span class="select2-selection__rendered" id="select2-vehicle_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="fuel_type" class="col-sm-5 col-form-label">Fuel Type <i class="text-danger">*</i></label>
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="fuel_type" id="fuel_type" data-select2-id="fuel_type" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="448">Please Select One</option>
                                                    <option value="Diesel">
                                                        Diesel</option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="447" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-fuel_type-container"><span class="select2-selection__rendered" id="select2-fuel_type-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="station_name" id="station_name" data-select2-id="station_name" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="453">Please Select One</option>
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="452" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-station_name-container"><span class="select2-selection__rendered" id="select2-station_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="driver_name" id="driver_name" onchange="getdrivermobile()" data-select2-id="driver_name" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="462">Please Select One</option>
                                                    <option value="2">Jaman - Shah Latif Express </option>
                                                    ...
                                                    <option value="12">Demo driver </option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="461" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-driver_name-container"><span class="select2-selection__rendered" id="select2-driver_name-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="refule_example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group">          <button class="btn btn-secondary buttons-copy buttons-html5 btn-success" tabindex="0" aria-controls="refule_example" type="button"><span>Copy</span></button> <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0" aria-controls="refule_example" type="button"><span>Excel</span></button> <button class="btn btn-secondary buttons-pdf buttons-html5 btn-success" tabindex="0" aria-controls="refule_example" type="button"><span>PDF</span></button> <button class="btn btn-secondary buttons-print btn-success" tabindex="0" aria-controls="refule_example" type="button"><span>Print</span></button> <div class="btn-group"><button class="btn btn-secondary buttons-collection dropdown-toggle buttons-colvis btn-success" tabindex="0" aria-controls="refule_example" type="button" aria-haspopup="true" aria-expanded="false"><span>Column visibility</span></button></div> </div></div><div class="col-lg-6 col-md-12"><div id="refule_example_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="refule_example"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="refule_example" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" role="grid" aria-describedby="refule_example_info" style="width: 1546px;">
                                                    <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 48px;" aria-sort="ascending" aria-label="SL: activate to sort column descending">SL</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 179px;" aria-label="Vehicle Name: activate to sort column ascending">Vehicle Name</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 155px;" aria-label="Last Reading: activate to sort column ascending">Last Reading</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 157px;" aria-label="Consumption: activate to sort column ascending">Consumption</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 145px;" aria-label="Strict Policy: activate to sort column ascending">Strict Policy</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 160px;" aria-label="Driver Mobile: activate to sort column ascending">Driver Mobile</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 121px;" aria-label="Fuel Type: activate to sort column ascending">Fuel Type</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 146px;" aria-label="Refuel Limit: activate to sort column ascending">Refuel Limit</th><th class="sorting" tabindex="0" aria-controls="refule_example" rowspan="1" colspan="1" style="width: 103px; display: none;" aria-label="Action: activate to sort column ascending">Action</th></tr>
                                                    </thead>
                                                    <tbody>
                                                ...
                                                </table></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="refule_example_info" role="status" aria-live="polite">Showing 1 to 5 of 5 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="refule_example_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="refule_example_previous"><a href="#" aria-controls="refule_example" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="refule_example" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="refule_example_next"><a href="#" aria-controls="refule_example" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/refuel_setting.js"></script></div>
