                ...
                <ul class="metismenu">
                    ...
                    <li class="mm-active">
                        ...
                        <ul class="nav-second-level mm-collapse mm-show" style="">
                            ...
                            <li class="mm-active">
                                <a style="cursor:pointer;" onclick="pageopen('https://vmsdemo.bdtask-demo.com/maintenance/Maintenance/approvalauthority')" aria-expanded="true">Manage Approval Authority</a>
                            </li>
    ...
    <div class="content-wrapper">
        <div class="main-content position-relative">
            ...
            <div class="body-content" id="bodycontent"><div id="add0" class="modal fade bd-example-modal-lg" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/add_approval" id="emp_form" class="row" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="req_type" id="req_type" data-select2-id="req_type" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="390">Please Select One</option>
                                                ...
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="389" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-req_type-container"><span class="select2-selection__rendered" id="select2-req_type-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control basic-single select2-hidden-accessible" required="" name="department" id="department" onchange="getemployee()" data-select2-id="department" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected="selected" data-select2-id="397">Please Select One</option>
                                                    <option value="mmkmk">
                                                        mmkmk</option>
                                                    ...
                                                    <option value="Accounting">
                                                        Accounting</option>
                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="396" style="width: auto;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-department-container"><span class="select2-selection__rendered" id="select2-department-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control basic-single select2-hidden-accessible" name="req_typesr" id="req_typesr" data-select2-id="req_typesr" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="402">Please Select One</option>
                                                <option value="Re-Fueling Requisition ">Re-Fueling Requisition </option>
                                                <option value="Maintenance Requisition">Maintenance Requisition </option>
                                                <option value="Vehicle Requisition">Vehicle Requisition </option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="401" style="width: 286.812px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-req_typesr-container"><span class="select2-selection__rendered" id="select2-req_typesr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-xl-4">
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control basic-single select2-hidden-accessible" name="req_phasesr" id="req_phasesr" data-select2-id="req_phasesr" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="407">Please Select One</option>
                                                <option value="Pending">Pending </option>
                                                <option value="Reject">Reject </option>
                                                <option value="Approved">Approved </option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="406" style="width: 286.812px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-req_phasesr-container"><span class="select2-selection__rendered" id="select2-req_phasesr-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-xl-4">
                                    <div class="form-group row mb-1">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control basic-single select2-hidden-accessible" name="status" id="status" data-select2-id="status" tabindex="-1" aria-hidden="true">
                                                <option value="" selected="selected" data-select2-id="412">Please Select One</option>
                                                <option value="Approved">Approved</option>
                                                <option value="Pending">Pending</option>
                                                <option value="Rejected">Reject</option>
                                            </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="411" style="width: 286.812px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-status-container"><span class="select2-selection__rendered" id="select2-status-container" role="textbox" aria-readonly="true" title="Please Select One">Please Select One</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group row  mb-1">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="authinfo_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dt-buttons btn-group">          <button class="btn btn-secondary buttons-copy buttons-html5 btn-success" tabindex="0" aria-controls="authinfo" type="button"><span>Copy</span></button> <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0" aria-controls="authinfo" type="button"><span>Excel</span></button> <button class="btn btn-secondary buttons-pdf buttons-html5 btn-success" tabindex="0" aria-controls="authinfo" type="button"><span>PDF</span></button> <button class="btn btn-secondary buttons-print btn-success" tabindex="0" aria-controls="authinfo" type="button"><span>Print</span></button> <div class="btn-group"><button class="btn btn-secondary buttons-collection dropdown-toggle buttons-colvis btn-success" tabindex="0" aria-controls="authinfo" type="button" aria-haspopup="true" aria-expanded="false"><span>Column visibility</span></button></div> </div></div><div class="col-lg-6 col-md-12"><div id="authinfo_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="authinfo"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="authinfo" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" role="grid" aria-describedby="authinfo_info" style="width: 1543px;">
                                                    <thead>
                                                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="authinfo" rowspan="1" colspan="1" style="width: 76px;" aria-sort="ascending" aria-label="SL: activate to sort column descending">SL</th><th class="sorting" tabindex="0" aria-controls="authinfo" rowspan="1" colspan="1" style="width: 311px;" aria-label="Requisition Type: activate to sort column ascending">Requisition Type</th><th class="sorting" tabindex="0" aria-controls="authinfo" rowspan="1" colspan="1" style="width: 283px;" aria-label="Requisition Phase: activate to sort column ascending">Requisition Phase</th><th class="sorting" tabindex="0" aria-controls="authinfo" rowspan="1" colspan="1" style="width: 229px;" aria-label="Department: activate to sort column ascending">Department</th><th class="sorting" tabindex="0" aria-controls="authinfo" rowspan="1" colspan="1" style="width: 283px;" aria-label="Employee: activate to sort column ascending">Employee</th><th class="sorting" tabindex="0" aria-controls="authinfo" rowspan="1" colspan="1" style="width: 140px;" aria-label="Action: activate to sort column ascending">Action</th></tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr role="row" class="odd"><td class="sorting_1" tabindex="0">1</td><td>Maintenance Requisition</td><td>Pending</td><td>Technical</td><td></td><td><input name="url" type="hidden" id="url_5" value="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/updateapprovalfrm"><a onclick="editinfo(5)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/delete_approval/5" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">2</td><td>Maintenance Requisition</td><td>Pending,Reject</td><td>ACCOUNTING</td><td>Kamrul,Test Employee</td><td><input name="url" type="hidden" id="url_9" value="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/updateapprovalfrm"><a onclick="editinfo(9)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/delete_approval/9" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">3</td><td>Maintenance Requisition</td><td>Reject</td><td>Marketing &amp; Sales</td><td></td><td><input name="url" type="hidden" id="url_11" value="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/updateapprovalfrm"><a onclick="editinfo(11)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/delete_approval/11" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr><tr role="row" class="even"><td class="sorting_1" tabindex="0">4</td><td>Maintenance Requisition</td><td>Reject</td><td>Technical</td><td></td><td><input name="url" type="hidden" id="url_24" value="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/updateapprovalfrm"><a onclick="editinfo(24)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/delete_approval/24" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr><tr role="row" class="odd"><td class="sorting_1" tabindex="0">5</td><td>Maintenance Requisition</td><td>Reject</td><td>ACCOUNTING</td><td>Test Employee</td><td><input name="url" type="hidden" id="url_25" value="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/updateapprovalfrm"><a onclick="editinfo(25)" style="cursor:pointer;color:#fff;" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil"></i></a><a href="https://vmsdemo.bdtask-demo.com/maintenance/maintenance/delete_approval/25" onclick="return confirm('Are you sure ?') " class="btn btn-xs btn-danger btn-sm mr-1"><i class="ti-trash"></i></a></td></tr></tbody>
                ...
                <script src="https://vmsdemo.bdtask-demo.com/assets/dist/js/approval_authority.js"></script></div>
