...
var KTSubscriptionsExport = function () {
    ...
    return {
        ...
        init: function () {
            // Elements
            element = document.querySelector('#kt_export_modal');
            modal = new bootstrap.Modal(element);

            form = document.querySelector('#kt_export_form');
            submitButton = form.querySelector('#kt_export_submit');
            cancelButton = form.querySelector('#kt_export_cancel');
            closeButton = element.querySelector('#kt_export_close');
