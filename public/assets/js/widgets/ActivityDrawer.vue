...
<template>
  ...
  >
    <div class="card shadow-none border-0 rounded-0">
      <!--begin::Header-->
      <div id="kt_activities_header" class="card-header">
      ...
      <!--begin::Body-->
      <div id="kt_activities_body" class="card-body position-relative">
        <!--begin::Content-->
        <div
                ...
                <div class="pe-3 mb-5">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <div
                      ...
                      title="Nina Nilson"
                    >
                      <img alt="img" src="@/assets/media/avatars/300-14.jpg" />
                    </div>
                    <!--end::User-->
                  </div>
                  <!--end::Description-->
                ...
                <div class="overflow-auto pb-5">
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="symbol symbol-circle symbol-25px">
                        <img alt="img" src="@/assets/media/avatars/300-2.jpg" />
                      </div>
                      <!--end::User-->
                  ...
                  >
                    ...
                    >
                      <!--begin::User-->
                      <div class="symbol symbol-circle symbol-25px">
                        <img alt="img" src="@/assets/media/avatars/300-20.jpg" />
                      </div>
                      <!--end::User-->
                ...
                <div class="overflow-auto pe-3">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <div
                      ...
                      title="Alan Nilson"
                    >
                      <img alt="img" src="@/assets/media/avatars/300-1.jpg" />
                    </div>
                    <!--end::User-->
                  </div>
                  <!--end::Description-->
                ...
                <div class="mb-5 pe-3">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <div
                      ...
                      title="Jan Hummer"
                    >
                      <img alt="img" src="@/assets/media/avatars/300-23.jpg" />
                    </div>
                    <!--end::User-->
                  </div>
                  <!--end::Description-->
                ...
                <div class="overflow-auto pb-5">
                  ...
                  >
                    ...
                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                      ...
                      <div class="ms-1 fw-semibold">
                        <!--begin::Desc-->
                        <a class="fs-6 text-hover-primary fw-bold" href="#"
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <!--begin::Title-->
                  <div class="fs-5 fw-semibold mb-2">
                    Task <a class="text-primary fw-bold me-1" href="#">#45890</a> merged
                    with <a class="text-primary fw-bold me-1" href="#">#45890</a> in “Ads
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <!--begin::Title-->
                  <div class="fs-5 fw-semibold mb-2">
                    New case <a class="text-primary fw-bold me-1" href="#">#67890</a>
                  ...
                  <div class="overflow-auto pb-5">
                    ...
                    <div class="d-flex align-items-center mt-1 fs-6">
                      ...
                      <!--begin::User-->
                      <a class="text-primary fw-bold me-1" href="#">Alice Tan</a>
                      <!--end::User-->
                    </div>
                    <!--end::Wrapper-->
                  </div>
                ...
                <div class="pe-3 mb-5">
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <div
                      ...
                      title="Robert Rich"
                    >
                      <img alt="img" src="@/assets/media/avatars/300-4.jpg" />
                    </div>
                    <!--end::User-->
                  </div>
                  <!--end::Description-->
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <!--begin::Title-->
                  <div class="fs-5 fw-semibold mb-2">
                    New order <a class="text-primary fw-bold me-1" href="#">#67890</a>
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <!--begin::User-->
                    <a class="text-primary fw-bold me-1" href="#">Jimmy Bold</a>
                    <!--end::User-->
                  </div>
                  <!--end::Description-->
                </div>
      ...
      <!--begin::Footer-->
      <div id="kt_activities_footer" class="card-footer py-5 text-center">
        <a class="btn btn-bg-body text-primary" href="user-profile/activity.html">
          View All Activities
