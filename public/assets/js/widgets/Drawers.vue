...
<template>
  ...
  >
    <!--begin::Messenger-->
    <div id="kt_drawer_chat_messenger" class="card w-100 rounded-0 border-0">
      <!--begin::Card header-->
          ...
          <div class="d-flex justify-content-start mb-10">
            ...
            <div class="d-flex flex-column align-items-start">
              ...
              <div class="d-flex align-items-center mb-2">
                ...
                <!--begin::Details-->
                <div class="ms-3">
                  <a class="fs-5 fw-bold text-gray-900 text-hover-primary me-1" href="#"
                  >Brian Cox</a
                  >
            ...
            <div class="d-flex flex-column align-items-end">
              ...
              <div class="d-flex align-items-center mb-2">
                ...
                <div class="me-3">
                  ...
                  <a class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1" href="#"
                  >You</a
                  >
                </div>
                <!--end::Details-->
              ...
              <div
                ...
                data-kt-element="message-text"
              >
                Hey there, we’re just writing to let you know that you’ve been subscribed
      ...
      <div id="kt_drawer_chat_messenger_footer" class="card-footer pt-4">
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Send-->
          <button class="btn btn-primary" data-kt-element="send" type="button">
            Send
          </button>
          <!--end::Send-->
        </div>
    ...
    <div class="card card-flush w-100 rounded-0">
      ...
      <div class="card-body hover-scroll-overlay-y h-400px pt-5">
        ...
        <div class="d-flex flex-stack">
          ...
          <div class="d-flex flex-column me-3">
            ...
            <div class="d-flex align-items-center">
              ...
              <a class="btn btn-sm btn-light-success btn-icon w-25px h-25px" href="#">
          ...
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-1.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Pic-->
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-3.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Pic-->
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-8.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Pic-->
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-26.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Pic-->
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-21.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Pic-->
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-34.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
        ...
        <div class="d-flex flex-stack">
          ...
          <!--begin::Pic-->
          <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
            <img alt="" src="@/assets/media/stock/600x400/img-27.jpg" />
          </div>
          <!--end::Pic-->
        </div>
        <!--end::Item-->
      ...
      <div class="card-footer">
        ...
        <div class="d-flex justify-content-end mt-9">
          <a class="btn btn-primary d-flex justify-content-end" href="#">Pleace Order</a>
        </div>
        <!--end::Action-->
      </div>
      <!--end::Card footer-->
