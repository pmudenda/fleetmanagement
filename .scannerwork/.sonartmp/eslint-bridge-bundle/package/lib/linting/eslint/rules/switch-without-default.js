...
const switchWithoutDefaultRule = {
    ...
    create(context) {
        ...
        const hasTypeInformation = (0, helpers_2.isRequiredParserServices)(services);
        return {
            SwitchStatement(node) {
                const { discriminant, cases } = node;
                if (hasTypeInformation && (0, helpers_2.isUnion)(discriminant, services)) {
                    return;
                }
 ...
 */
const switchExhaustivenessRule = eslint_plugin_1.rules['switch-exhaustiveness-check'];
const decoratedSwitchExhaustivenessRule = (0, helpers_1.interceptReport)((0, decoration_1.sanitizeTypeScriptESLintRule)(switchExhaustivenessRule), function (context, descriptor) {
