...
exports.decorateNoRedundantTypeConstituents = void 0;
const helpers_1 = require("./helpers");
function decorateNoRedundantTypeConstituents(rule) {
    return (0, helpers_1.interceptReport)(rule, reportExempting);
}
exports.decorateNoRedundantTypeConstituents = decorateNoRedundantTypeConstituents;
